...
class Timer:
    ...
    def __enter__(self):
        raise NotImplementedError("TODO [Step 1.6]: Implement Timer.__enter__")

    def __exit__(self, *args):
        raise NotImplementedError("TODO [Step 1.6]: Implement Timer.__exit__")
...
def profile_ort_session(onnx_path, dummy_input_np, num_warmup=10, num_runs=100):
    ...
    # =========================================================================
    raise NotImplementedError("TODO [Step 1.6]: Implement profile_ort_session")
...
def get_model_info(onnx_path):
    ...
    # }
    # =========================================================================
    raise NotImplementedError("TODO [Step 1.6]: Implement get_model_info")
