...
def export_to_onnx(model, dummy_input, output_path, opset_version=13,
    ...
    # =========================================================================
    raise NotImplementedError("TODO [Step 1.5]: Implement ONNX export")
...
def verify_onnx(onnx_path, model, dummy_input, atol=1e-5):
    ...
    # =========================================================================
    raise NotImplementedError("TODO [Step 1.5]: Implement ONNX verification")
...
if __name__ == "__main__":
    ...
    # =========================================================================
    print("TODO: Implement ONNX export main script")
